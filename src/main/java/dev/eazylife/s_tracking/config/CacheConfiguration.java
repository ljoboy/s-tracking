package dev.eazylife.s_tracking.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(dev.eazylife.s_tracking.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(dev.eazylife.s_tracking.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
