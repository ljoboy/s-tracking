...
export class HistoriquesComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.historiquesService
            ...
            .subscribe(
                (res: HttpResponse<IHistoriques[]>) => this.paginateHistoriques(res.body, res.headers),
    ...
    trackId(index: number, item: IHistoriques) {
        return item.id;
    }
    ...
    private paginateHistoriques(data: IHistoriques[], headers: HttpHeaders) {
