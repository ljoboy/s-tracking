...
import { HistoriquesComponent } from 'app/entities/historiques/historiques.component';
...
describe('Component Tests', () => {
    describe('Historiques Management Component', () => {
        let comp: HistoriquesComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(HistoriquesComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.historiques[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
