...
import { VoituresComponent } from 'app/entities/voitures/voitures.component';
...
describe('Component Tests', () => {
    describe('Voitures Management Component', () => {
        let comp: VoituresComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(VoituresComponent, '')
                .compileComponents();
